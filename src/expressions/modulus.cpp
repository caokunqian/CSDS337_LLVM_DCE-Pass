...
std::unique_ptr<VarType> ASTExpressionModulus::ReturnType(ASTFunction& func)
{
...
bool ASTExpressionModulus::IsLValue(ASTFunction& func)
{
...
llvm::Value* ASTExpressionModulus::Compile(llvm::IRBuilder<>& builder, ASTFunction& func)
{
...
std::string ASTExpressionModulus::ToString(const std::string& prefix)
{
    std::string ret = "(*)\n";
