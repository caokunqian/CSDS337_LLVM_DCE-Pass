...
class ASTExpressionModulus : public ASTExpression
{
private:
...
public:
    ...
    ASTExpressionModulus(std::unique_ptr<ASTExpression> a1, std::unique_ptr<ASTExpression> a2) : a1(std::move(a1)), a2(std::move(a2)) {}
    ...
    {
        return std::make_unique<ASTExpressionModulus>(std::move(a1), std::move(a2));
    }
